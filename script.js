...
// Function to remove book (corrected spelling)
function removeBook(index) {
  books = books.filter((_, i) => i !== index); //(_, i) => i !== index the position (or index) of each book in the collection. index parameter tells us which book to remove.
